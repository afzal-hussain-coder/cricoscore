...
public class ScheduleMatchAdapter extends RecyclerView.Adapter<ScheduleMatchAdapter.MyHolder>{
    ...
    public ScheduleMatchAdapter(Context mContext, List<ScheduleMatchActivity.Match> tList){
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.mb_add_player_first.setOnClickListener(v -> {
            if(holder.rl_player_add.getVisibility() == View.VISIBLE){
                ...
                value1 = count.getAndIncrement();
                holder.tvPlayerFirstCount.setText(String.valueOf(value1));
...
//        ValueSetter valueSetter = new ValueSetter();
//        if(valueSetter.getValue1() == 15 && valueSetter.getValue2()==15){
//            holder.mb_start_tournament.setVisibility(View.VISIBLE);
//        }else{
//            holder.mb_start_tournament.setVisibility(View.GONE);
//        }
