...
public class BattingStyleAdapter extends RecyclerView.Adapter<BattingStyleAdapter.MyViewHolder>{
    ...
    public BattingStyleAdapter(Context mContext, ArrayList<BattingStyleModel> midWicketList , coachItemClickListener coachItemClickListener){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        BattingStyleModel battingStyleModel = midWicketList.get(position);
        holder.setItem(battingStyleModel.getText());
    }
