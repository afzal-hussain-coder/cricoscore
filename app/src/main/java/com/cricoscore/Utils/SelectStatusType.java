...
public class SelectStatusType extends TextView implements View.OnClickListener, PopupWindow.OnDismissListener {

    private ArrayList<DataModel> optionList = new ArrayList<>();
    private SelectStatusType.onClickInterface onClickInterface;

    public SelectStatusType(Context context) {
        super(context);
        initView();
    }

    public SelectStatusType(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public SelectStatusType(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private PopupWindow popupWindowSort(Context context) {
        ...
        popupWindow.setBackgroundDrawable(context.getDrawable(R.drawable.dropbox_status));
    ...
    public void setClickListener(SelectStatusType.onClickInterface listener) {
