...
public class SelectTournamentType extends TextView implements View.OnClickListener, PopupWindow.OnDismissListener {

    private ArrayList<DataModel> optionList = new ArrayList<>();
    private SelectTournamentType.onClickInterface onClickInterface;

    public SelectTournamentType(Context context) {
        super(context);
        initView();
    }

    public SelectTournamentType(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public SelectTournamentType(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private PopupWindow popupWindowSort(Context context) {
        ...
        popupWindow.setBackgroundDrawable(context.getDrawable(R.drawable.drop_bg));
    ...
    public void setClickListener(SelectTournamentType.onClickInterface listener) {
